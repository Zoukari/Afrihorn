...
export function FloatingActions() {
  ...
  const langLabel = lang === 'ar' ? 'AR' : lang === 'fr' ? 'FR' : 'EN';

  return (
    <div className={styles.container}>
      {/* Language Selector - above WhatsApp */}
        ...
        <AnimatePresence>
          {isLangOpen && (
            ...
            >
              ...
              <button
                type="button"
                className={`${styles.langOption} ${lang === 'fr' ? styles.active : ''}`}
              ...
              <button
                type="button"
                className={`${styles.langOption} ${lang === 'ar' ? styles.active : ''}`}
